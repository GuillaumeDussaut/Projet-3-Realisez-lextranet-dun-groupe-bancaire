...
$req = $bdd->query('SELECT id, titre, contenu, img, DATE_FORMAT(date_creation, \'%d/%m/%Y à %Hh%imin%ss\') AS date_creation_fr FROM Acteurs ORDER BY date_creation DESC LIMIT 0, 5');
